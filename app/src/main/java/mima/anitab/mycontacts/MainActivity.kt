...
class MainActivity : AppCompatActivity() {
   lateinit var binding:ActivityMainBinding
    ...
    fun displayContacts(){
        ...
        var contact3=Contacts("yusuf", "0113247436", "naimasalim027@gmail.com", "Bajuri-lamu", "https://images.unsplash.com/photo-1539701938214-0d9736e1c16b?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTR8fGJsYWNrJTIwcGVvcGxlfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60")
